...
1. Free cloud hosting for your HospitalRun instance (note: this instance should be paired/synced with a local install of HospitalRun that you'll be responsible for deployment, but don't worry we'll couch you through it).
